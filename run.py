...
def mmdrza() :
    ...
    while True :
        ...
        console.print(Panel(str(MmdrzaPanel) , title = "[white]Ethereum Mnemonic Checker V2[/]" , subtitle = "[green_yellow blink] www.genesislab.ch [/]" , style = "green") , style = style , justify = "full")
